...
# alias myclass="source /home/henrique/Documents/SoLAr/WVFAnaSoLAr/class/load_my_class.sh"
...
if [ $file == 'no' ]; then
    eval 'root -e ".L /home/henrique/Documents/SoLAr/WVFAnaSoLAr/class/MYCODES.h$compile_flag"'
else
    eval 'root -e ".L /home/henrique/Documents/SoLAr/WVFAnaSoLAr/class/MYCODES.h$compile_flag" -e "ANALYZER s(\"s\")" -e "s.setAnalyzer(\"$file\")"'
fi
